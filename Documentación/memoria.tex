...
\noindent Que el alumno D. \nombre, con DNI 71757204X, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado Mixing Models. 
...
\begin{abstract}
En este documento se exponen el proceso de desarrollo de una herramienta de cálculos estadísticos sobre Mixing Models, este tipo de herramientas suelen resolver problemas en el ámbito de la ecología, permitiendo calcular las contribuciones de las fuentes a las plantas a partir de trazadores. 

Se ha creado una aplicación web que utiliza las librería GLPK para resolver problemas de maximización y minimización por medio de una interfaz en Typescript. Esta aplicación web permite visualizar y exportar resultados. El código de la aplicación web esta desarrollado en Angular y utiliza otros lenguajes habituales en las aplicaciones web como HTML y CSS. La aplicación esta internacionalizada a los idiomas Español e Inglés.
...
\begin{abstract}
This document presents the development process of a statistical calculation tool on Mixing Models, this type of tool usually solves problems in the field of ecology, allowing to calculate the contributions of the sources to the plants from tracers. 

A web application has been created that uses the GLPK library to solve maximisation and minimisation problems by means of a Typescript interface. This web application allows to visualise and export results. The code of the web application is developed in Angular and uses other common languages in web applications such as HTML and CSS. The application is internationalised in Spanish and English.
